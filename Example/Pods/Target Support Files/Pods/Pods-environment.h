...
// BMAGridPageControl
#define COCOAPODS_POD_AVAILABLE_BMAGridPageControl
#define COCOAPODS_VERSION_MAJOR_BMAGridPageControl 1
#define COCOAPODS_VERSION_MINOR_BMAGridPageControl 0
#define COCOAPODS_VERSION_PATCH_BMAGridPageControl 1
